    ...
    return (
      <div className="min-h-screen bg-[#101014] flex flex-col items-center justify-center p-4">
        <div
          ...
          style={{ fontFamily: "Inter, Helvetica Neue, Arial, sans-serif" }} // ✅ replaced with Inter for better web support
        >
          {/* Header */}
          <div className="fixed top-[45px] left-1/2 transform -translate-x-1/2 w-full max-w-md bg-black flex items-start justify-between p-6 pb-4 z-50 rounded-t-lg">
            <button
              onClick={handleReset}
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {[
            ["fromEmail", "From Email", "email", "finance@disigni.com"],
            ...
            ["buyerName", "Buyer Name", "text", "Nileshkumar Khupase"],
